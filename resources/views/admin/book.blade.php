    ...
    <div class="main-agileinfo">
        <div class="agileits-top" style="background-color:#D19C97;">
            <form action="save_book" method="post" enctype="multipart/form-data">
                @csrf
                <input style="background-color:#D19C97" type="text" name="bookname" placeholder="Enter book name" value="{{old('bookname')}}" required><br>
                @error('bookname')
                ...
                <input style="background-color:#D19C97" type="text" name="price" placeholder="Enter book price" value="{{old('price')}}" required><br>
                @error('price')
                <div class="alert alert-danger mt-1 mb-1">
                    {{ $message }}
                </div>
                ...
                <input style="background-color:#D19C97" type="text" name="qty" placeholder="Quantity in Stock" value="{{old('qty')}}" required><br>
                @error('qty')
                <div class="alert alert-danger mt-1 mb-1">
                    {{ $message }}
                </div>
                ...
                <input style="background-color:#D19C97" type="text" name="discount" placeholder="Discount if any" value="{{old('discount')}}" required><br>
                @error('discount')
                <div class="alert alert-danger mt-1 mb-1">
                    {{ $message }}
                </div>
                ...
                @enderror
                <input type="submit" value="Add Book" style="background-color:navy;color:white;border-radius:18px;">
            </form>
        </div>
    </div>
